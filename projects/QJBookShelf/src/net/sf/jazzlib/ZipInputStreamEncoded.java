/*
 * net.sf.jazzlib.ZipInputStream Copyright (C) 2001, 2002, 2003 Free Software Foundation, Inc. This file is part of GNU
 ...
 * not obligated to do so. If you do not wish to do so, delete this exception statement from your version. Added support
 * for specifying an encoding for the zip archive
 */
 ...
 * etc. It includes support for STORED and DEFLATED entries.
 * 
 * @author Jochen Hoenicke
 */
public class ZipInputStreamEncoded
        ...
        ZipConstants
{
        ...
        throws IOException
    {
        ...
        {
            name = new String( buffer, this.charset );
        }
        else
        {
        ...
        switch ( method )
        {
            case ZipOutputStream.DEFLATED:
                ...
                if ( len < 0 )
                {
                    ...
                    {
                        throw new ZipException( "size mismatch: " + csize + ";" + size + " <-> " + inf.getTotalIn() +
                            ";" + inf.getTotalOut() );
                    }
                    inf.reset();
                    finished = true;
     ...
     */
    protected ZipEntry createZipEntry(
        String name )
    {
