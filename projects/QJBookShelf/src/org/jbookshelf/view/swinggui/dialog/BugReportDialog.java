    ...
    Translatable
{
    ...
    private final WrapperPanel  descriptionPanel                      = new WrapperPanel( description );
    private final WrapperPanel  expectedPanel                         = new WrapperPanel( expected );
    private final WrapperPanel  actualPanel                           = new WrapperPanel( actual );
    ...
    public boolean apply()
    {
        ...
        URIUtil.mail( "bug-report", body.toString() );
